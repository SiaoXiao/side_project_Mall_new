<template>
  <Layout>
    <PageContainer>
      <PageHeader>
        <template #title>隱私權保護政策</template>
      </PageHeader>
      <main class="mb-10">
        <p class="mb-2 text">
          非常歡迎您光臨，為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        </p>
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">
          一、 隱私權保護政策的適用範圍
        </h3>
        <p class="mb-2 text">
          隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。
        </p>
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">二、 資料的蒐集與使用方式</h3>
        <p class="mb-2 text">
        ...
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">三、資料之保護</h3>
        <p class="mb-2 text">
          本網站主機均設有防火牆、防毒系統等相關的各項資訊安全設備及必要的安全防護措施，加以保護網站及您的個人資料。採用嚴格的保護措施，只由經過授權的人員才能接觸您的個人資料，相關處理人員皆簽有保密合約，如有違反保密義者，將會受到相關的法律處分。如因業務需要有必要委託本部相關單位提供服務時，本網站亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。
        </p>
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">四、網站對外的相關連結</h3>
        <p class="mb-2 text">
          本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站中不適用於本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
        </p>
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">五、Cookie之使用</h3>
        <p class="mb-2 text">
          為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie
          ，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行。
        </p>
        <h3 class="text-lg font-medium tracking-wide text-[#252422]">六、隱私權保護政策之修正</h3>
        <p class="text">本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。</p>
        <br />
        <h2 class="my-3 titleText">會員服務條款</h2>
        <ol class="pl-6 space-y-1 list-decimal text">
          <li>本會員服務條款所稱之「會員」，為依照本站所定之加入會員程序加入完成並通過認證者。</li>
          <li>當您使用本站服務時，即表示您同意及遵守本服務條款的規定事項及相關法律之規定。</li>
          <li>本站有審核加入會員資格之權利，另外已加入會員者本站亦保留有解除其會員資格之權利。</li>
